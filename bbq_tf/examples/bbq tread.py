...
if __name__ == "__main__":
    ...
    ax.add_patch(Rectangle((-0.5, -0.5), 1.0, 1.0, fill=None, alpha=1,
    ...
    p1 = (np.random.uniform(-5, -4), np.random.uniform(-60, -60))
    p2 = (np.random.uniform(-5, -4), np.random.uniform(60, 60))

    p1B = (np.random.uniform(-5, -4), np.random.uniform(-60, -60))
    p2B = (np.random.uniform(-5, -4), np.random.uniform(60, 60))
