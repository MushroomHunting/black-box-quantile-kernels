...
if __name__ == "__main__":
    ...
    p1 = (np.random.uniform(-3, -2), np.random.uniform(-48, -32))
    p2 = (np.random.uniform(-3, -2), np.random.uniform(32, 48))

    p1B = (np.random.uniform(-3, -2), np.random.uniform(-48, -32))
    p2B = (np.random.uniform(-3, -2), np.random.uniform(32, 48))
